...
const LiveLocationBox = ({ className = "" }) => {
      ...
      <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
        <svg xmlns="http://www.w3.org/2000/svg" width="330" height="430" fill="none" viewBox="0 0 330 430" className="w-full h-full max-w-[280px] max-h-[360px] scale-110">
          <g clipPath="url(#a)">
            ...
            <g>
              ...
              <path 
                ...
                fill="none"
              />
              {/* Animated green rectangle moving along the line */}
              <g mask="url(#lineMask)">
                <motion.g
                  initial={{ y: 285 }}
                  animate={{ y: 205 }}
          ...
          <defs>
            ...
            <linearGradient id="b" x1="130.011" x2="290.2" y1="159.677" y2="369.686" gradientUnits="userSpaceOnUse">
              <stop stopColor="#fff"/>
              <stop offset="1" stopColor="#fff" stopOpacity="0"/>
            </linearGradient>
            <linearGradient id="f" x1="161.952" x2="200.942" y1="287.31" y2="282.386" gradientUnits="userSpaceOnUse">
              <stop stopColor="#fff"/>
              <stop offset="1" stopColor="#fff" stopOpacity="0"/>
            </linearGradient>
            <linearGradient id="g" x1="176.291" x2="146.084" y1="291.992" y2="317.019" gradientUnits="userSpaceOnUse">
              <stop stopColor="#ededed"/>
              <stop offset="1" stopColor="#fff" stopOpacity="0"/>
            </linearGradient>
            <linearGradient id="h" x1="142.094" x2="49.005" y1="298.08" y2="374.208" gradientUnits="userSpaceOnUse">
              <stop stopColor="#ededed"/>
              <stop offset="1" stopColor="#fff" stopOpacity="0"/>
            </linearGradient>
            <linearGradient id="i" x1="163.45" x2="151.98" y1="286.878" y2="260.371" gradientUnits="userSpaceOnUse">
              <stop stopColor="#ededed"/>
              <stop offset="1" stopColor="#fff" stopOpacity="0"/>
            </linearGradient>
            <linearGradient id="j" x1="163.939" x2="120.03" y1="317.43" y2="406.478" gradientUnits="userSpaceOnUse">
              <stop stopColor="#ededed"/>
              <stop offset="1" stopColor="#fff" stopOpacity="0"/>
            </linearGradient>
            <linearGradient id="k" x1="211.598" x2="210.244" y1="358.54" y2="423.039" gradientUnits="userSpaceOnUse">
              <stop stopColor="#ededed"/>
              <stop offset="1" stopColor="#fff" stopOpacity="0"/>
            </linearGradient>
            <linearGradient id="l" x1="252.624" x2="289.44" y1="386.02" y2="398.696" gradientUnits="userSpaceOnUse">
              <stop stopColor="#ededed"/>
              <stop offset="1" stopColor="#fff" stopOpacity="0"/>
            </linearGradient>
            <linearGradient id="m" x1="163.45" x2="163.45" y1="266.262" y2="288.695" gradientUnits="userSpaceOnUse">
              <stop stopColor="#ededed"/>
              <stop offset="1" stopColor="#fff" stopOpacity="0"/>
            </linearGradient>
            <radialGradient id="d" cx="0" cy="0" r="1" gradientTransform="rotate(227.429 99.037 139.361)scale(103.192 103.372)" gradientUnits="userSpaceOnUse">
              <stop stopColor="#fff"/>
              <stop offset="1" stopColor="#d9d9d9" stopOpacity="0"/>
            </radialGradient>
            <radialGradient id="e" cx="0" cy="0" r="1" gradientTransform="rotate(246.038 108.464 128.218)scale(61.4062 126.439)" gradientUnits="userSpaceOnUse">
            ...
            <linearGradient id="fadeMask" x1="0%" y1="0%" x2="0%" y2="100%" gradientUnits="userSpaceOnUse">
...
export default LiveLocationBox;
